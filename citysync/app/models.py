...
class Nonprofit(db.Model):
    ...
    asset_amt = db.Column(db.Integer, unique=False, nullable=False)
    income_amt = db.Column(db.Integer, unique=False, nullable=False)
    revenue_amt = db.Column(db.Integer, unique=False, nullable=False)
